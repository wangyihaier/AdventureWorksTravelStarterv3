...
namespace PBIWebApp
{
    ...
    public partial class Main : Page
    {
        ...
        //string baseMLUri = "https://asiasoutheast.services.azureml.net/workspaces/bce6720f1cae4df39a77df12ea819f5d/services/ee1679341f45429690e6a90a4167fdf7/execute?api-version=2.0&details=true";
        //string sampleWeatherUri = http://api.wunderground.com/api/45c9142713e257d9/conditions/q/CA/San_Francisco.json 
        ...
        private void InitAirports()
        {
            ...
            {
                new Airport() {AirportCode ="SEA",State="WA",AirportWundergroundID="SEA"},
                new Airport() { AirportCode ="ABQ",State="NM", AirportWundergroundID="ABQ" },
                new Airport() { AirportCode ="ANC",State="AK", AirportWundergroundID="ANC" },
                new Airport() { AirportCode ="ATL",State="GA", AirportWundergroundID="ATL" },
                new Airport() { AirportCode ="AUS",State="TX", AirportWundergroundID="AUS" },
                new Airport() { AirportCode ="CLE",State="OH", AirportWundergroundID="CLE" },
                new Airport() { AirportCode ="DTW",State="MI", AirportWundergroundID="DTW" },
                new Airport() { AirportCode ="JAX", State="FL",AirportWundergroundID="JAX" },
                new Airport() { AirportCode ="MEM", State="TN",AirportWundergroundID="MEM" },
                new Airport() { AirportCode ="MIA", State="FL",AirportWundergroundID="MIA" },
                new Airport() { AirportCode ="ORD", State="IL",AirportWundergroundID="zmw:60666.6.99999" },
                new Airport() { AirportCode ="PHX",State="AZ", AirportWundergroundID="PHX" },
                new Airport() {AirportCode ="SAN", State="CA",AirportWundergroundID="zmw:92140.5.99999" },
                new Airport() {AirportCode ="SFO", State="CA",AirportWundergroundID="SFO"},
                new Airport() {AirportCode ="SJC", State="CA",AirportWundergroundID="SJC"},
                new Airport() {AirportCode ="SLC", State="UT",AirportWundergroundID="SLC"},
                new Airport() {AirportCode ="STL", State="MO",AirportWundergroundID="STL"},
                new Airport() {AirportCode ="TPA", State="FL",AirportWundergroundID="TPA"}
            };
        }
        ...
        private async Task PredictDelays(DepartureQuery query, ForecastResult forecast)
        {
            ...
            try
            {
                using (var client = new HttpClient())
                {
                   ...
                   // client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", "F6T2BPEnofjq8vyeWzSa5DcsUx/eAFDxhK6CB9WLcKNxPhCTg4cWVBBiKb1I+g2LPZLF4+ANhbOvRcwLbynNVQ==");
    ...
    public class Airport
    {
        ...
        public string QueryKey { get { return State + "/" + AirportCode; } }
    }
}
